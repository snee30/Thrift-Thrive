      ...
      <div className="pt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {allProducts.length === 0 ? (
          ...
          allProducts.map((product, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-md p-4 border border-darksage hover:shadow-lg transition duration-200"
            >
                ...
                product.status !== "pending payment" && (
                  <div className="mt-3 text-sm text-gray-700 space-y-1">
                    ...
                    <button
                      ...
                      className="mt-3 w-full bg-forestgreen text-white px-4 py-2 rounded-md hover:bg-green-700 transition"
                    >
                      Update Status
                    </button>
                  </div>
